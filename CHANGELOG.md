...
- **BREAKING**: Made the aggregator modules and the autojac package protected. They should now
  always be imported via their package (e.g. `from torchjd.aggregation.upgrad import UPGrad` should
  become `from torchjd.aggregation import UPGrad`, and
