...
def _jac(
    ...
    The first dimension of the jacobians is equal to the length of the sequence of `outputs`, which
    should be the same as the length of the sequence of `grad_outputs`. This should be equivalent to
    calling `_grad(outputs[i], inputs, grad_outputs[i], ...)` for all i sequentially, and stacking
    the elements of each resulting tuple.
    """
