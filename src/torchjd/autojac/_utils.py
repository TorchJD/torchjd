...
def _get_leaves_of_autograd_graph(tensors: list[Tensor], excluded: set[Tensor]) -> set[Tensor]:
    """
    Gets the leaves of the autograd graph of all specified ``tensors``, excluding the ``excluded``
    tensors and their descendants.
