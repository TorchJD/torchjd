...
def mtl_backward(
    ...
    r"""
    In the context of Multi-Task Learning (MTL), we often have a shared model to extract features,
    followed by several task-specific heads. A loss can then be computed for each task.
