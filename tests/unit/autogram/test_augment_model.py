...
from unit.autogram._architectures import (
    ...
    InterModuleParamReuseModel,
    MIMOBranchedModel,
    MISOBranchedModel,
    ModelWithFreeParameter,
    ModelWithModuleReuse,
    ModelWithModuleWithoutOutput,
...
@mark.parametrize(
    ...
    [
        ...
        (SIPOBranchedModel, 64, 3),
        (ParamReuseModule, 64, 3),
        (InterModuleParamReuseModel, 64, 3),
        (ModelWithModuleReuse, 64, 3),
        (ModelWithFreeParameter, 64, 3),
        (ModelWithNoFreeParameter, 64, 3),
        (ModuleWithUnusedParam, 64, 3),
        (ModuleWithFrozenParam, 64, 3),
        (SingleInputPyTreeOutputModule, 32, 3),
        (PyTreeInputPyTreeOutputModule, 32, 3),
        (PyTreeInputSingleOutputModule, 32, 3),
        (PIPOBranchedModel, 32, 3),
...
@mark.parametrize(
    ...
    [
        ...
        (SIPOBranchedModel, 64),
        (ParamReuseModule, 64),
        (InterModuleParamReuseModel, 64),
        (ModelWithModuleReuse, 64),
        (ModelWithFreeParameter, 64),
        (ModelWithNoFreeParameter, 64),
        (ModuleWithUnusedParam, 64),
        (ModuleWithFrozenParam, 64),
        (SingleInputPyTreeOutputModule, 32),
        (PyTreeInputPyTreeOutputModule, 32),
        (PyTreeInputSingleOutputModule, 32),
