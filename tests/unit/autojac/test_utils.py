...
def test_simple_get_leaves_of_autograd_graph():
    ...
    leaves = _get_leaves_of_autograd_graph(tensors=[y1, y2])
    assert leaves == {p1, p2}


def test_get_leaves_of_autograd_graph_excluded_1():
    """
...
def test_get_leaves_of_autograd_graph_excluded_2():
    """
    Tests that _get_leaves_of_autograd_graph works correctly when some tensors are excluded from the
    search.
...
def test_get_leaves_of_autograd_graph_excluded_3():
    """
    Tests that _get_leaves_of_autograd_graph works correctly when some tensors are excluded from the
    search.
...
def test_get_leaves_of_autograd_graph_leaf_not_requiring_grad():
    """
...
def test_get_leaves_of_autograd_graph_model():
    """
    ...
    leaves = _get_leaves_of_autograd_graph(tensors=[losses])
    assert leaves == set(model.parameters())


def test_get_leaves_of_autograd_graph_model_excluded_1():
    """
    Tests that _get_leaves_of_autograd_graph works correctly when the autograd graph is generated by
...
def test_get_leaves_of_autograd_graph_model_excluded_2():
    """
    Tests that _get_leaves_of_autograd_graph works correctly when the autograd graph is generated by
...
def test_get_leaves_of_autograd_graph_single_root():
    ...
    leaves = _get_leaves_of_autograd_graph(tensors=[y])
    assert leaves == {p}
...
def test_get_leaves_of_autograd_graph_empty_roots():
    ...
    leaves = _get_leaves_of_autograd_graph(tensors=[])
    assert leaves == set()
...
def test_get_leaves_of_autograd_graph_deep(depth: int):
    ...
    leaves = _get_leaves_of_autograd_graph(tensors=[sum_])
    assert leaves == {one}
